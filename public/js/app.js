        ...
        //fetch('http://localhost:3000/weather?address=').then((response) => {
            response.json().then((data) => {
                ...
                if (data.error) {
                    ...
                    messageOne.textContent = 'It is currently ' + data.temperature + 'C and it feels like ' + data.feelslike + 'C. It is ' + data.weather_description + ' humidity is ' + data.humidity + '% in ' + data.location
                }
            })
        })
})
